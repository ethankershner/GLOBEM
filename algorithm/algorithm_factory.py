...
from algorithm.dl_torch_modality_token_reorder_mae import (
    DepressionDetectionAlgorithm_DL_torch_modality_token_mae,
)
...
def load_algorithm(config_name:str) -> DepressionDetectionAlgorithmBase:
    ...
    if (config_name.startswith("ml_saeb")):
        ...
        algorithm = DepressionDetectionAlgorithm_DL_torch_modality_token_reorder(config_name = config_name)
    elif (config_name.startswith("dl_torch_modality_token")):
        algorithm = DepressionDetectionAlgorithm_DL_torch_modality_token(config_name = config_name)
